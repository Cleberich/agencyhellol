  ...
  return (
    <>
      ...
      <div className="bg-[#fff] h-screen -mt-16 ">
        ...
        <h2 className="text-[46px] font-[900] text-center -mt-4 text-[#062740]">
        ...
        <div className="bg-gradient-to-b from-[#151616] to-[#1F2F3D] py-[115px] sm:px-0 px-12">
          <main className="max-w-[1290px] flex justify-center flex-col mx-auto">
            {" "}
