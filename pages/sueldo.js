...
export default function sueldo() {
  ...
  return (
    <div className="bg-[#1a1a1a] w-full h-screen  ">
      <video
        autoPlay
        loop
        muted
        ...
        className="w-full h-[100vh] slide-in-bottom md:block hidden"
        src="/videos/fondito.mp4"
      />
      <video
        autoPlay
        loop
        ...
        playsInline
        webkit-playsinline="true"
        className="w-full h-screen slide-in-bottom block md:hidden"
        src="/videos/sueldo.mp4"
      />
      <section className="relative md:-mt-[750px] -mt-[850px]">
        {" "}
        <div className="py-12">
        ...
        <div className="flex w-[90%] md:w-[700px] justify-center bg-white rounded-t-md p-8 shadow-md mx-auto ">
          <form className="">
            <main className="md:grid md:grid-cols-3 grid grid-cols-2 place-content-center gap-2 ">
              ...
              <div>
                {" "}
                <label className="block w-full text-black">Tienes hijos</label>
                <select
        ...
        <main className="grid grid-cols-2 mx-auto h-52  bg-white py-12 px-2 w-[90%] md:w-[700px] ">
        ...
        <main className="grid grid-cols-2 mx-auto h-20 rounded-b-md bg-white pb-12 px-2 w-[90%] md:w-[700px]">
          <div className="">
